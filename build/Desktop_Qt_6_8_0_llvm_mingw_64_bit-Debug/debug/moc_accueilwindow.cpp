...
struct qt_meta_stringdata_CLASSAccueilWindowENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSAccueilWindowENDCLASS = QtMocHelpers::stringData(
    "AccueilWindow",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSAccueilWindowENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject AccueilWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSAccueilWindowENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSAccueilWindowENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSAccueilWindowENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *AccueilWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSAccueilWindowENDCLASS.stringdata0))
