...
static constexpr auto qt_meta_stringdata_ZN11commentaireE = QtMocHelpers::stringData(
    "commentaire"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN11commentaireE[] = {
...
Q_CONSTINIT const QMetaObject commentaire::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11commentaireE.offsetsAndSizes,
    qt_meta_data_ZN11commentaireE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11commentaireE_t,
        // Q_OBJECT / Q_GADGET
...
void *commentaire::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11commentaireE.stringdata0))
