...
static constexpr auto qt_meta_stringdata_ZN7AddBookE = QtMocHelpers::stringData(
    "AddBook",
    "on_parccourriBtn_clicked",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN7AddBookE[] = {
...
Q_CONSTINIT const QMetaObject AddBook::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN7AddBookE.offsetsAndSizes,
    qt_meta_data_ZN7AddBookE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN7AddBookE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<AddBook, std::true_type>,
        // method 'on_parccourriBtn_clicked'
...
void AddBook::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->on_parccourriBtn_clicked(); break;
        default: ;
        }
    }
    (void)_a;
...
void *AddBook::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN7AddBookE.stringdata0))
